...
export function ReachFilter({ min }: { min: string }) {
  ...
  return (
    <div className="mb-3 rounded-2xl bg-canvas p-3.5 shadow-card">
      ...
      <div className="flex items-end gap-2">
        <input type="date" value={r1} min={min} onChange={(e) => set("r1", e.target.value)}
          className="w-full min-w-0 flex-1 rounded-xl border border-line-strong bg-canvas px-2 py-2.5 text-[13px] outline-none focus:border-ink" />
