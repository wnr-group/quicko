  ...
  return (
    <header className="pt-safe sticky top-0 z-20 bg-canvas/85 px-4 pb-3 backdrop-blur-md">
      ...
      <div className="mt-3 flex items-center gap-2">
        <div className={`h-1.5 flex-1 rounded-full ${step >= 1 ? "bg-brand" : "bg-line"}`} />
        <div className={`h-1.5 flex-1 rounded-full ${step >= 2 ? "bg-brand" : "bg-line"}`} />
      </div>
          ...
          <>
            ...
            <Card>
              ...
              <div className="flex items-end gap-2">
                <label className="min-w-0 flex-[1.3]">
                  ...
                  <input type="date" value={departDate} min={today}
                    ...
                    className="w-full min-w-0 rounded-xl border border-line-strong bg-canvas px-3 py-2.5 text-[15px] outline-none focus:border-ink" />
                </label>
